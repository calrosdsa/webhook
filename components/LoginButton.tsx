...
const LoginButton = () =>{
  ...
  const router = useRouter()
    ...
    return(
        <div className='flex w-72 rounded-2xl bg-facebook  items-center'>
            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="48px" height="48px"><path fill="#039be5"
             ...
             <button className='text-white font-semibold truncate'
         onClick={buttonAction}>{ui.buttonText}</button>
        </div>
    )
}
